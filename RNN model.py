...
This is a side project from Wei-Hsi, Hsu.
Nowadays, violent, bloody, and porny news contents are increasing in Taiwan, but they are not suitable for 12-year-old children reading actually. To protect these young audiences' mental health, I build a deep learning model that can avoid them from reaching these types of news. In the project, I use Python and RNN(Recurrent Neural Network) model to fulfill my goal, and every detailed step is in the below.
"""
...
3.   Save as s CSV file and upload to google drive.
"""
...
Numbers in the news headlines do not affect deep learning too much. Use the regular expression (`re`) to remove all the numbers.
...
"""### 03. Compute each word's frequency of showing up
...
After testing, the ratio of 8:2 is the best training results.
"""
